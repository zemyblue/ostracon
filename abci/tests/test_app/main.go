...
func testCounter() {
	...
	commit(client, nil)
	deliverTx(client, []byte{0x00}, abci.CodeTypeOK, nil)
	commit(client, []byte{0, 0, 0, 0, 0, 0, 0, 1})
	deliverTx(client, []byte{0x00}, code.CodeTypeBadNonce, nil)
	deliverTx(client, []byte{0x01}, abci.CodeTypeOK, nil)
	deliverTx(client, []byte{0x00, 0x02}, abci.CodeTypeOK, nil)
	deliverTx(client, []byte{0x00, 0x03}, abci.CodeTypeOK, nil)
	deliverTx(client, []byte{0x00, 0x00, 0x04}, abci.CodeTypeOK, nil)
