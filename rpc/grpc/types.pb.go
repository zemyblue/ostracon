...
var fileDescriptor_907c7db099111068 = []byte{
	...
	,
}
...
type BroadcastAPIClient interface {
	Ping(ctx context.Context, in *grpc1.RequestPing, opts ...grpc.CallOption) (*grpc1.ResponsePing, error)
...
func (c *broadcastAPIClient) Ping(ctx context.Context, in *grpc1.RequestPing, opts ...grpc.CallOption) (*grpc1.ResponsePing, error) {
	out := new(grpc1.ResponsePing)
...
type BroadcastAPIServer interface {
	Ping(context.Context, *grpc1.RequestPing) (*grpc1.ResponsePing, error)
...
func (*UnimplementedBroadcastAPIServer) Ping(ctx context.Context, req *grpc1.RequestPing) (*grpc1.ResponsePing, error) {
...
func _BroadcastAPI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BroadcastAPIServer).Ping(ctx, req.(*grpc1.RequestPing))
	}
