...
type State struct {
	...
	Voters      *types2.VoterSet    `protobuf:"bytes,1001,opt,name=voters,proto3" json:"voters,omitempty"`
	LastVoters  *types2.VoterSet    `protobuf:"bytes,1002,opt,name=last_voters,json=lastVoters,proto3" json:"last_voters,omitempty"`
	VoterParams *types2.VoterParams `protobuf:"bytes,1003,opt,name=voter_params,json=voterParams,proto3" json:"voter_params,omitempty"`
}
...
func (m *State) GetVoters() *types2.VoterSet {
	if m != nil {
		return m.Voters
	}
	return nil
...
func (m *State) GetLastVoters() *types2.VoterSet {
	if m != nil {
		return m.LastVoters
	}
	return nil
...
func (m *State) GetVoterParams() *types2.VoterParams {
	if m != nil {
...
var fileDescriptor_898987a4421067cd = []byte{
	...
	,
}
...
func (m *State) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1003:
			...
			if m.VoterParams == nil {
				m.VoterParams = &types2.VoterParams{}
			}
