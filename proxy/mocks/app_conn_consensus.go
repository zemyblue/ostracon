...
func (_m *AppConnConsensus) BeginBlockSync(_a0 types.RequestBeginBlock) (*tmabci.ResponseBeginBlock, error) {
	ret := _m.Called(_a0)
...
func (_m *AppConnConsensus) EndBlockSync(_a0 tmabci.RequestEndBlock) (*types.ResponseEndBlock, error) {
	ret := _m.Called(_a0)
